...
function CardHistoricCallRoot(props: ICardHistoricCallProps) {
  return (
    <button
      className={clsx(
...
CardHistoricCallRoot.displayName = 'CardHistoricCall.Root'
...
IconHistoricCall.displayName = 'CardHistoricCall.Icon'


export const CardHistoricCall = {
  Root: CardHistoricCallRoot,
